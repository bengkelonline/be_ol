                ...
                <div class="card">
                    ...
                    <div class="card-body card-block">
                        <div class="row form-group">
                            ...
                            <div class="col-8">
                                <div class="form-group">
                                    <input type="text" id="Nama" value="<?php echo $w['nama'] ?>"  >
                                </div>
                            </div>
                            <div class="col-3">
                                <div class="form-group">
                            ...
                            <div class="col-9">
                                <div class="form-group">
                                    ...
                                    <textarea id="alamat"> <?php echo $w['alamat'] ?></textarea>
                                </div>
                            </div>
                            <div class="col-3">
                                <div class="form-group">
                            ...
                            <div class="col-8">
                                <div class="form-group">
                                    <input type="text" id="no_telfon" value="<?php echo $w['no_telfon'] ?>"  >
                                </div>
                            </div>
                            <div class="col-3">
                                <div class="form-group">
                            ...
                            <div class="col-8">
                                <div class="form-group">
                                    <input type="text" id="tanggal_lahir" value="<?php echo $w['tgl_lahir'] ?>"  >
                                </div>
                            </div>
                            <div class="col-3">
                                <div class="form-group">
                            ...
                            <div class="col-8">
                                <div class="form-group">
                                    <input type="text" id="jenis_kelamin" value="<?php echo $w['jenis_kelamin'] ?>"  >
                                </div>
                            </div>
                            <div class="col-3">
                                <div class="form-group">
                                    <label for="jenis_kelamin" class=" form-control-label">Email</label>
                                </div>
                            </div>
                            <div class="col-9">
                                <div class="form-group">
                                    <input type="text" id="jenis_kelamin" value="<?php echo $w['email'] ?>"  >
                                </div>
                            </div>
                        </div>
                    </div>
