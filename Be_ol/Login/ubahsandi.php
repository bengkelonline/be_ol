			...
			<div class="wrap-login100">
				...
				<form action="reset.php" method="post" class="login100-form validate-form">
					...
					<div class="wrap-input100 validate-input" data-validate = "Valid email is required: ex@abc.xyz">
						...
						<input class="input100" type="text" name="email" value="<?php echo $email ?>" placeholder="Email" disabled="disabled">
					...
					<div class="container-login100-form-btn">
						<input type="submit" name="submit" value="Change" class="login100-form-btn">
					</div>
