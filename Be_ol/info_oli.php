  ...
  <header id="header" class="header header-hide">
    <div class="container">
      ...
      <nav id="nav-menu-container">
        <ul class="nav-menu">
          <li class="menu-active"><a href="index.php #testimonials">Home</a></li>
          <li><a href="index.php #about-us">About Us</a></li>
          <li><a href="index.php #team">Info Sparepart dan Oli</a></li>
          <li><a href="index.php #contact">Help</a></li>
          <li><a href=""></a></li>
          <li><a href=""></a></li>
...
<?php 
  ...
  $query = mysqli_query($connect, "SELECT * FROM info WHERE kategori = 'Oli'");
