...
<?php
    include("config.php");
    $query = mysqli_query($connect, "SELECT * FROM harga_sevice ORDER BY km ASC");
?>
<!DOCTYPE html>
<html lang="en">
                ...
                <div class="modal-dialog modal-sm" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="smallmodalLabel">Tambah Tarif</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <div class="modal-body">
                            <form action="insert_data_harga.php" method="post" >
                                <div class="form-group">
                                    <label for="km" class=" form-control-label">KM</label>
                                    <input type="number" id="km" name="km" placeholder="km" class="form-control">
                                </div>
                                <div class="form-group">
                                    <label for="harga" class=" form-control-label">Harga</label>
                                    <span class="help-block">Rp.</span>
                                    <input type="number" id="harga" name="harga" placeholder="Harga" class="form-control">
                                </div>
                                <div class="form-group">
